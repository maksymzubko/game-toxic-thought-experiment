    ...
    return (
        <div className="info-modal">
            <div className="modal">
                ...
                <p>
                    {props?.leader ?
                        "The leading player chooses one of the answers to the question that suits him best within 60 seconds. Skipping a question means you need a drink."
                        :
                        "The rest of the players have 60 seconds to guess which answer the leading player has chosen. A wrong answer or omission of an answer means you need to drink."
                    }
                </p>
